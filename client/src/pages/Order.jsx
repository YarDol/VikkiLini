                    ...
                    <Left>
                      <Details>
                        ...
                        <ProductDetails>
                          ...
                          <ProductInfo>{t('qt')} {i.productId.quantity}</ProductInfo>
                        </ProductDetails>
                      </Details>
                    </Left>
                    <Center>
            ...
            <Summary>
              <SummaryLeft>
                ...
                <SummaryDiv left={"left"}>
                  ...
                  <SummaryItem>
                    <SummaryItemLeft>{t('subt')}</SummaryItemLeft>
                    <SummaryItemRight>
                      {totalAmount < 5249
                  ...
                  <Hr height={"2px"} />
                  <SummaryItem>
                    <SummaryItemLeft>{t('total')}</SummaryItemLeft>
                    <SummaryItemRight>
                      {formatAmount(totalAmount - 240)}
                    </SummaryItemRight>
                  </SummaryItem>
                </SummaryDiv>
              </SummaryLeft>
