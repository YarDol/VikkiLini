      ...
      <MainContainer>
        ...
        <TextContainer>
          ...
          {currentUser.isAdmin && (
            <Right>
              <Action>
                <Link href="https://vikkilini-admin.netlify.app">
                  <Text>{t('apanel')}</Text>
        ...
        <Wrapper>
          <Header>{t('usIf')}</Header>
          <InfoContainer>
            <Category>
              <InfoText>{t('profile.6')}</InfoText>
            </Category>
            <Value>
          ...
          <InfoContainer>
            <Category>
              <InfoText>{t('profile.10')}</InfoText>
            </Category>
            <Value>
              <InfoText>••••••••••</InfoText>
            </Value>
