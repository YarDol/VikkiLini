    ...
    <Container>
      ...
      <Wrapper>
        ...
        <InfoContainer>
          ...
          <ChoiceContainer>
            <ChoiceWrapper>
              <ChoiceTitle>{t('colors')}</ChoiceTitle>
              {product.color?.map((c) => (
                <ColorOutline
                  key={c}
                  id={c}
          ...
          <ChoiceTitle>{t('size')}</ChoiceTitle>
          <ChoiceContainer>
            <ChoiceWrapper>
              {product.size?.map((s) => {
                return (
          ...
          <ChoiceContainer>
            <ChoiceWrapper>
              <ChoiceTitle>{t('quan')}</ChoiceTitle>
              <QuantityWrapper>
                <QuantityButton
          ...
          <ButtonContainer>
            <Button onClick={addToBag}>
              <ShoppingBagOutlinedIcon style={{ marginRight: "10px" }} /> {t('addB')}
            </Button>
          </ButtonContainer>
          <Left>
            <DescriptionContainer>
              <AccessTimeOutlinedIcon />
              <Description>{t('deliv')}</Description>
            </DescriptionContainer>
          </Left>
          <Left>
            <DescriptionContainer>
              <LocalShippingOutlinedIcon />
              <Description>{t('fsoa')}</Description>
            </DescriptionContainer>
          </Left>
        </InfoContainer>
      </Wrapper>
      <PopularProducts description={t('ppl')} />
      <Newsletter />
      <Footer />
    </Container>
  );
